...
I do not support or spread any of the terms.
...
## Installation
You put the .lua file in the AutoRun folder and the Blacklist.txt in the main folder where the start file for the server is. You must create a new folder called **Configs** that is in the same folder as the Server start file and put the Config.txt in there.
